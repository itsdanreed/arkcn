...
Every data primitive in the toolkit renders its own `LiveRegion`, so they work without any provider. Use the same pair in your own components rather than a bespoke hidden div.
